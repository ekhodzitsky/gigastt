...
```sh
gh release download v2.11.2 -R ekhodzitsky/gigastt \
...
minisign -Vm gigastt-2.11.2-aarch64-apple-darwin.tar.gz -p gigastt.pub
```
...
```sh
gh attestation verify gigastt-2.11.2-aarch64-apple-darwin.tar.gz \
