"""Runner for Vosk 0.54 (Zipformer2)."""
...
class Vosk054Runner:
    ...
    def __init__(self, model_name: str = None, download_dir: str | None = None):
        ...
        if model_name is None:
            model_name = os.environ.get("BENCHMARK_VOSK_054_MODEL", "vosk-model-ru-0.54")
    ...
    def _download_model(self) -> Path:
        ...
        print(f"[vosk-0.54] Downloading model from {url} ...")
    ...
    def is_available(self) -> bool:
        try:
            ...
            print(f"[vosk-0.54] Not available: {e}")
            return False
